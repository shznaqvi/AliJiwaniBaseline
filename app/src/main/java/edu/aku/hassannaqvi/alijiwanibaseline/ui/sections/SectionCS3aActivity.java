...
import edu.aku.hassannaqvi.alijiwanibaseline.databinding.ActivitySectionCs3aBinding;
...
public class SectionCS3aActivity extends AppCompatActivity {
    ...
    private boolean updateDB() {
        ...
        int updcount = 0;
        try {
            updcount = db.updatesChildColumn(TableContracts.ChildTable.COLUMN_CS31, child.cS31toString());
    ...
    public void btnContinue(View view) {
        ...
        if (updateDB()) {
            ...
            i = new Intent(this, SectionCS3bActivity.class).putExtra("complete", true);
           /* } else {
