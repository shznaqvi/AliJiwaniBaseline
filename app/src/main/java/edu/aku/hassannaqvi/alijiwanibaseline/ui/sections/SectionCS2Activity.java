...
public class SectionCS2Activity extends AppCompatActivity {
    ...
    private boolean updateDB() {
        ...
        int updcount = 0;
        try {
            updcount = db.updatesChildColumn(TableContracts.ChildTable.COLUMN_CS2, child.cS2toString());
    ...
    public void btnContinue(View view) {
        if (!formValidation()) return;
         ...
         if (updateDB()) {
            ...
            i = new Intent(this, SectionCS3aActivity.class).putExtra("complete", true);
           /* } else {
