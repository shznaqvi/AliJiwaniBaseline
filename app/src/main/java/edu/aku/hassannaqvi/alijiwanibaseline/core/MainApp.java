package edu.aku.hassannaqvi.alijiwanibaseline.core;
...
public class MainApp extends Application {
    ...
    public static final String PROJECT_NAME = "alijiwanibaseline";
    ...
    public static final String _UPDATE_URL = MainApp._IP + "/alijiwani/app/hhsurvey";
