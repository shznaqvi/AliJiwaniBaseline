...
import edu.aku.hassannaqvi.alijiwanibaseline.databinding.ActivitySectionCs3bBinding;
...
public class SectionCS3bActivity extends AppCompatActivity {
    ...
    private boolean updateDB() {
        ...
        int updcount = 0;
        try {
            updcount = db.updatesChildColumn(TableContracts.ChildTable.COLUMN_CS32, child.cS32toString());
    ...
    public void btnContinue(View view) {
        ...
        if (updateDB()) {
            ...
            i = new Intent(this, SectionCS4Activity.class).putExtra("complete", true);
           /* } else {
