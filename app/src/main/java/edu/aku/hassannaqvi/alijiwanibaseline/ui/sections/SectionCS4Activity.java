...
import edu.aku.hassannaqvi.alijiwanibaseline.databinding.ActivitySectionCs4Binding;
...
public class SectionCS4Activity extends AppCompatActivity {
    ...
    private boolean updateDB() {
        ...
        int updcount = 0;
        try {
            updcount = db.updatesChildColumn(TableContracts.ChildTable.COLUMN_CS4, child.cS4toString());
    ...
    public void btnContinue(View view) {
        ...
        if (updateDB()) {
            ...
            i = new Intent(this, SectionCS5Activity.class).putExtra("complete", true);
           /* } else {
