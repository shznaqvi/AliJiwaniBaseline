...
import edu.aku.hassannaqvi.alijiwanibaseline.databinding.ActivitySectionBs3Binding;
...
public class SectionBS3Activity extends AppCompatActivity {
    ...
    private boolean updateDB() {
        ...
        int updcount = 0;
        try {
            updcount = db.updatesWraColumn(TableContracts.WRATable.COLUMN_SB3, wra.sB3toString());
    ...
    public void btnContinue(View view) {
        ...
        if (updateDB()) {
            ...
            i = new Intent(this, SectionBS5Activity.class).putExtra("complete", true);
           /* } else {
