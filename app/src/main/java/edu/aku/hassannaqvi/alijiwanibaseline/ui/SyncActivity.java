package edu.aku.hassannaqvi.alijiwanibaseline.ui;

import static edu.aku.hassannaqvi.alijiwanibaseline.core.MainApp.PROJECT_NAME;
import static edu.aku.hassannaqvi.alijiwanibaseline.core.MainApp.sdDir;
import static edu.aku.hassannaqvi.alijiwanibaseline.core.MainApp.uploadData;
import static edu.aku.hassannaqvi.alijiwanibaseline.utils.AndroidUtilityKt.isNetworkConnected;
...
import edu.aku.hassannaqvi.alijiwanibaseline.adapters.SyncListAdapter;
...
import edu.aku.hassannaqvi.alijiwanibaseline.databinding.ActivitySyncBinding;
import edu.aku.hassannaqvi.alijiwanibaseline.models.SyncModel;
import edu.aku.hassannaqvi.alijiwanibaseline.workers.DataDownWorkerALL;
import edu.aku.hassannaqvi.alijiwanibaseline.workers.DataUpWorkerALL;
import edu.aku.hassannaqvi.alijiwanibaseline.workers.PhotoUploadWorker2;
        ...
        if (sdDir.exists()) {
            ...
            if (files.length > 0) {
                ...
                for (int i = 0; i < fcount; i++) {
                    TextView textView = new TextView(edu.aku.hassannaqvi.alijiwanibaseline.ui.SyncActivity.this);
                    ...
                    handler.postDelayed(new Runnable() {
                        ...
                        public void run() {
                            ...
                            WorkManager.getInstance(SyncActivity.this).getWorkInfoByIdLiveData(photoUpload.getId())
                                    .observe(edu.aku.hassannaqvi.alijiwanibaseline.ui.SyncActivity.this, new Observer<WorkInfo>() {
                                        ...
                                        public void onChanged(@Nullable WorkInfo workInfo) {
                                            ...
                                            if (workInfo.getState() == WorkInfo.State.FAILED) {
                                                Toast.makeText(edu.aku.hassannaqvi.alijiwanibaseline.ui.SyncActivity.this, "Failed", Toast.LENGTH_SHORT).show();
